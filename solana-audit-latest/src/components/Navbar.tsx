      ...
      <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <div
            title={
              firebaseSynced
                ...
                : 'Local Server Storage Active: Operating on fast local storage and memory cache'
            }
          ...
          >
            ...
            <span className="hidden sm:inline text-[#a1a1aa]">Storage:</span>
            <span className="font-bold text-[#ff9100]">
              {firebaseSynced ? 'SYNCED' : 'LOCAL STORE'}
            </span>
          </div>
